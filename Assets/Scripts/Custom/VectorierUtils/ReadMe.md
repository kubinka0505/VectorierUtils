...
## `basic_build_and_run.cs`
- Menu Items Locations:
  01. `Vectorier/BuildMap + Run game (Steam)`

Performs map building operation and runs the game immediately.

> [!WARNING]
> Assuming game version is from Steam, ignores window size setting — **always launches in fullscreen**.
